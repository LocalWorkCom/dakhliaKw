                ...
                <div class="header mx-5 mt-5">
                    ...
                    <div class="row d-flex justify-content-center ">
                        <div class="text-request">
                            <p>   @if ($vacation->employee && $vacation->employee->grade)
                                {{ $vacation->employee->grade->name }} 
                            @endif
                             / {{ $vacation->employee->name }}  </p>
                        </div>
                    </div>
                    <div class="row d-flex justify-content-center mb-5">
                    ...
                    <div class="row qoute " dir="rtl">
                        <p class=" "> نحيطكم علما بأن المذكؤر أعلاه قد باشر العمل لدينا بتاريخ 
                            ...
                            <p>بعد حصوله على أجازة <span>{{ $vacation->vacation_type->name }}</span> مدتها <span>{{ $vacation->days_number }}</span> يوم</p>
...
بدأت بتاريخ                            <span>{{ $vacation->start_date }}</span>
                    ...
                    <div class="row inputs-request-handprint d-flex justify-content-between " style="  color:#04209b;" dir="rtl">
 ...
 <div class="row qoute " dir="rtl">
     <p class="mt-5 mb-5"> تتم تحديد الاجازة للمذكؤر اعلاه و ارسلت للادارة العامة لشؤن قوة الشرطة و ذلك بتارييخ .. / .. / ....
     </p>
 </div>
