                    ...
                    <div class="select-wrapper">
                        ...
                        <div class="options" id="options">
                            <div class="search-box">
                                <input name="Id_number" type="text" id="search-input" placeholder="ابحث هنا ....." style="width: 100% !important;" value="{{ $inspector->name }}">
                            </div>
        ...
        <div class="form-row  mx-md-5 mx-1 mb-2 pb-4">
            ...
            <tbody>
                    <tr>
                        ...
                        <td style="background: #f5f6fa;" id="user-grade_id">{{ $inspector->position }}</td>
                    </tr>
                    <input type="hidden" name="position" id="hidden-position">
                    <tr>
                        <th scope="row">الاسم</th>
                        <td id="user-name">{{ $inspector->name }}</td>
                    </tr>
                    <input type="hidden" name="name" id="hidden-name">
                    <tr>
                        <th scope="row">رقم الهاتف</th>
                        <td id="user-phone">{{ $inspector->phone }}</td>
                    </tr>
        ...
        <div class="form-row mx-md-5 mx-2 mb-2 d-block justify-content-start" dir="rtl">
            <div class="form-group d-flex">
                <div class="radio-btn  d-flex">
                    <input type="radio" id="intern" name="type" {{ old('type', $inspector->type) == 'in' ? 'checked' : '' }} value="in" required>
            ...
            <div class="form-group d-flex">
                <div class="radio-btn  d-flex">
                    <input type="radio" id="intern" name="type" {{ old('type', $inspector->type) == 'trainee' ? 'checked' : '' }} value="trainee" required>
                    <label for="intern">مفتش متدرب</label>
                </div>
            </div>
            <div class="form-group d-flex">
                <div class="radio-btn  d-flex">
                    <input type="radio" id="intern" name="type" {{ old('type', $inspector->type) == 'Buildings' ? 'checked' : '' }} value="Buildings" required>
