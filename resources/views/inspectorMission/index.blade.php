                ...
                <table class="table table-bordered  table-responsive table-container " border="1" dir="rtl">
                    ...
                    <tbody>
                        ...
                        <tr class="group-table">
                            <!-- Team Name Row -->
                            <td colspan="2" style=" text-align: center;background-color: #e4f1ffbd; color:black;">
                                {{ $team->name }}</td>
                        ...
                        <tr>
                            ...
                            <td class="{{ $class }}"
                                ...
                                <ul>
                                    <!-- Mission Points -->
                                    @if (!$mission->day_off && isset($mission['points']) && count($mission['points']) >
                                    0)
                                    ...
                                    <!-- Instant Missions -->
                                    @if (!$mission->day_off && isset($mission['instant_missions']) &&
                                    count($mission['instant_missions']) > 0)
