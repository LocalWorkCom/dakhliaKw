    ...
    <div class="row">
        <div class="container welcome col-11">
            <div class="d-flex justify-content-between">
                <p>الصـــلاحيات</p>
                <button type="button" class="wide-btn" onclick="window.location.href='{{ route('permission.create') }}'"
                    style="    color: #0D992C;">
            ...
            columnDefs: [{
                ...
                render: function(data, type, row) {
                    ...
                    return `
                       ...
                       <a href="` + permissiondelete +
                        `" class="btn  btn-sm " style="background-color: #C91D1D;"> <i class="fa-solid fa-trash"></i>حذف </a>`;
                }
