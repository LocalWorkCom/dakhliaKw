        ...
        <div class="container moftsh col-11 mt-3 p-0 pb-3 ">
            ...
            <div class="form-row mx-2 mb-2 ">
                <div class="input-group moftsh2 px-md-5 px-3 pt-3">
                    ...
                    <input type="text" id="name" class="form-control" name="name" placeholder=" اسم النقطه" required />
            ...
            <div class="form-row   mx-2 mb-2 ">
                ...
                <div class="input-group moftsh2 px-md-5 px-3 pt-3 col-6">
                    ...
                    <input type="number" id="days_num" name="days_num" class="form-control" max="7" min="1" required />
                </div>
            </div>
            ...
            <div class="form-row mx-2 mb-2 ">
                <div class="input-group moftsh2 px-md-5 px-3 pt-3">
                    ...
                    <textarea type="text" id="note" name="note" class="form-control note"
                        placeholder="ملاحظتك"></textarea>
                </div>
            </div>
            <div class="container col-11 ">
                <div class="form-row d-flex justify-content-end mt-4 mb-3">
                    ...
                    <button type="submit" class="btn-blue">
                        <img src="{{ asset('frontend/images/white-add.svg') }}" alt="img" height="20px" width="20px">
                        اضافة</button>
                </div>
            </div>
        </div>
