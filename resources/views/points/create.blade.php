                ...
                <div class="form-row   mx-2 mb-2 ">
                    <div class="input-group moftsh2 px-md-4 px-3 pt-3 col-6">
                        ...
                        <select name="time_type" id="time_type"
                            class=" form-control custom-select custom-select-lg mb-3 select2 "
                            style="border: 0.2px solid rgb(199, 196, 196); width:100% !important;" required>
                            <option value="0"{{ old('time_type') == 0 ? 'selected' : '' }}>نظام 24 ساعه</option>
                            <option value="1"{{ old('time_type') == 1 ? 'selected' : '' }}>نظام دوام جزئى </option>
                        ...
                        <div class="col-6 col-md-5 col-lg-4 my-2">
                            <div class="form-check" style="direction: rtl">
                                <input type="checkbox" id="exampleCheck{{ $item->id }}" value="{{ $item->id }}"
                                    name="option_ids[]" class="form-check-input selectPermission"
