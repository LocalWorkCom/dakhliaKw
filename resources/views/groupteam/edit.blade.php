...
@section('content')
    <div class="row col-11" dir="rtl">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('groupTeam.index') }}">الفرق </a></li>
    ...
    <div class="row" dir="rtl">
        <div class="container moftsh col-11 mt-3 pt-3 pb-3 ">
            ...
            <form class="edit-grade-form" id="" action="" method="POST">
                @csrf
                        ...
                        <div class="radio-buttons" id="radio-buttons{{ $index }}" style="display: none;">
                            <div class="d-flex justify-content-start">
                                ...
                                @foreach ($allteams as $item)
                                        ...
                                        name="options{{ $index }}" value="option{{ $groupIndex }}" {{ $item->id == $groupTeamId ? 'checked':'' }}>
