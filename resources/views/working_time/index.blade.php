...
@section('content')
        ...
        <div class="container welcome col-11">
            <div class="d-flex justify-content-between">
                ...
                <button type="button" class="btn-all  " onclick="openadd()"
                    ...
                    اضافة فترة <img src="{{ asset('frontend/images/add-btn.svg') }}"
                        alt="">
                </button>
            </div>
                        ...
                        <table id="users-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th> لون الفترة</th>
                                    <th style="width:150px !important;">العمليات
                                    </th>
                                </tr>
                            </thead>
                        </table>
                    ...
                    <div id=""
                        ...
                        <div class="container"
                            ...
                            <div class="form-group mt-4 mb-3">
                                <label
                                    class="d-flex justify-content-start pt-3 pb-2"
                                    for="name_show">
                                    اسم الفتره</label>
                                <input type="text" id="name_show"
                                    name="name_show" class="form-control"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="start_time_show"
                                    name="start_time_show" class="form-control"
                                    disabled>
                            </div>
                            <div class="form-group mb-3">
                                <label class="d-flex justify-content-start pb-2"
                                    ...
                                    نهاية
                                    فترة العمل</label>
                                <input type="text" id="end_time_show"
                                    name="end_time_show" class="form-control"
                                    disabled>
                            </div>
                            <div class="form-group mb-3">
                                <label class="d-flex justify-content-start pb-2"
                                    for="color_show"> لون
                                    فترة العمل</label>
                                <input type="color" id="color_show"
                                    name="color_show" class="form-control"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    <form id="createForm"
                        action="{{ route('working_time.store') }}" method="post">
                        @csrf
                        <div id="firstModalBody"
                            class="mb-3 mt-3 d-flex justify-content-center">
                            <div class="container"
                                style="border: 0.2px solid rgb(166, 165, 165);">
                                <div class="form-group mt-4 mb-3">
                                ...
                                <div
                                    class="text-end d-flex justify-content-end mx-2 pb-4 pt-2">
                                    <button type="submit"
                                        class="btn-all mx-2 p-2"
                    ...
                    <div id="secondModalBodycreate" class="d-none">
                        <div class="body-img-modal d-block mb-4">
                            <img src="{{ asset('frontend/images/ordered.svg') }}"
                                alt="">
    ...
    <div class="modal fade" id="edit" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    <form id="editForm"
                        action="{{ route('working_time.update') }}"
                        method="post">
                        @csrf
                        @method('POST')
                        @if ($errors->any())
                        ...
                        @endif
                        <input type="hidden" id="idedit" name="id_edit"
                            value="">
                        <div id="firstModalBody1"
                            class="mb-3 mt-3 d-flex justify-content-center">
                            <div class="container"
                                style="border: 0.2px solid rgb(166, 165, 165);">
                                <div class="form-group mt-4 mb-3">
                                ...
                                <div class="form-group mb-3">
                                    <label
                                        ...
                                        for="color_edit"> لون
                                        فترة العمل</label>
                                    <input type="color" id="color_edit"
                                        name="color_edit" class="form-control"
                                        value="#ffffff" required>
                                    <div id="editColorError"
                                        class="error-message text-danger"
                                        style="display: none;">
                                    </div>
    ...
    <div class="modal fade" id="delete" tabindex="-1"
        aria-labelledby="opendelete" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-center">
                    <div class="title d-flex flex-row align-items-center">
                ...
                <div class="modal-body  mt-3 mb-5">
                    <div class="container pt-5 pb-3"
                        style="border: 0.2px solid rgb(166, 165, 165);">
                        <form id="delete-form"
                            action="{{ route('working_time.delete') }}"
                            method="POST">
                            @csrf
                            <div class="form-group d-flex justify-content-center ">
                                <h5 class="modal-title " id="opendelete"> هل تريد
                                    حذف هذه الفترة ؟</h5>


                                <input type="text" id="id"
                                    value="" hidden name="id"
                                    class="form-control">
                            </div>
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        document.getElementById('name_show').value =
                            data.name;
                        document.getElementById('start_time_show')
                            .value = data.start_time;
                        document.getElementById('end_time_show').value =
                            data.end_time;
                        document.getElementById('color_show').value =
                            data.color;
    ...
    <script>
        document.getElementById('createForm').addEventListener('submit', function(
            ...
            if (!endTime) {
                document.getElementById('endTimeError').textContent =
                    'نهاية فترة العمل مطلوبة';
                document.getElementById('endTimeError').style.display =
                    'block';
                hasError = true;
            }
            ...
            if (hasError) {
                ...
                if (colorErrorMessage) {
                    document.getElementById('colorError').textContent =
                        colorErrorMessage;
                    document.getElementById('colorError').style.display =
                        'block';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editForm.addEventListener('submit', function(event) {
                var editName = document.getElementById('name_edit')
                    .value.trim();
                var editStartTime = document.getElementById(
                    'start_time_edit').value.trim();
                var editEndTime = document.getElementById(
                    'end_time_edit').value.trim();
                var editColor = document.getElementById(
                    'color_edit').value.trim();

                var editHasError = false;

                // Clear previous error messages
                document.getElementById('name_editError').style
                    .display = 'none';
                document.getElementById('start_time_editError')
                    .style.display = 'none';
                document.getElementById('end_time_editError').style
                    .display = 'none';
                document.getElementById('editColorError').style
                    .display = 'none';

                // Validate the name field
                if (!editName) {
                    document.getElementById('name_editError')
                        .textContent = 'اسم الفترة مطلوب';
                    document.getElementById('name_editError').style
                        .display = 'block';
                    editHasError = true;
                }
                ...
                if (!editStartTime) {
                    document.getElementById('start_time_editError')
                        .textContent = 'بداية فترة العمل مطلوبة';
                    document.getElementById('start_time_editError')
                        .style.display = 'block';
                    editHasError = true;
                }
                ...
                // Validate the end_time field
                if (!editEndTime) {
                    document.getElementById('end_time_editError')
                        .textContent = 'نهاية فترة العمل مطلوبة';
                    document.getElementById('end_time_editError')
                        .style.display = 'block';
                    editHasError = true;
                }
                ...
                if (editHasError) {
                    ...
                    const editColorErrorMessage =
                        '{{ $errors->first('color_edit') }}';
                    if (editColorErrorMessage) {
                        document.getElementById('editColorError')
                            .textContent = editColorErrorMessage;
                        document.getElementById('editColorError')
                            .style.display = 'block';
                        event
