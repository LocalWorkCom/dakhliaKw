    ...
    <div class="container  col-11 mt-3 p-0  pt-5 pb-4">
        ...
        <div class="col-lg-12">
            <div class="bg-white ">
                                        ...
                                        <div class="container" style="border: 0.2px solid rgb(166, 165, 165);">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="start_time" class="form-control"
                                                    placeholder="Select time" name="start_time" required>
                                                <div id="startTimeError" class="error-message text-danger"
                                                    style="display: none;"></div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div id="endTimeError" class="error-message text-danger"
                                                    style="display: none;"></div>
                                    ...
                                    <div id="firstModalBody1" class="mb-3 mt-3 d-flex justify-content-center">
                                        <div class="container" style="border: 0.2px solid rgb(166, 165, 165);">
                                            <div class="form-group mt-4 mb-3">
                                                ...
                                                <div id="name_editError" class="error-message text-danger"
                                                    style="display: none;"></div>
                                            </div>
                                            <div class="form-group mb-3">
                ...
                <script>
                    function openedit(id, name, start, end, color) {
                        document.getElementById('name_edit').value = name;
                        document.getElementById('start_time_edit').value = start;
                        document.getElementById('end_time_edit').value = end;
                    ...
                    document.getElementById('myModal1').addEventListener('hidden.bs.modal', function() {
                        // Reset the form
                        document.getElementById('createForm').reset();

                        // Optionally reset other elements like colors
                    ...
                    function openEditModal(id, name) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    var data = response.data;
                                    // Set form action to the update route with the correct ID
                                    document.getElementById('editForm').action = '/working_time/update/' + data.id;
