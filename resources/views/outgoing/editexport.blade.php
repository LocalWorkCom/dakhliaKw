        ...
        <div class="container  col-11 mt-3 p-0 ">
            <div class="row " dir="rtl">
                <div class="form-group mt-4  mx-2 col-12 d-flex ">
                    ...
                    <button type="button" class="btn-all mx-3" data-bs-toggle="modal" id="addFile-dev"
...
<button class="btn-all" type="submit">
    <img src="" alt="">تعديل
        ...
        <!-- **********modal******** -->
        <div class="modal fade" id="addFile" tabindex="-1" aria-labelledby="extern-departmentLabel"
            aria-hidden="true">
                        ...
                        <div class="card-block">
                            ...
                            <form action="{{ route('Export.update', ['Export' => $data->id]) }}" method="POST"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="nameex">العنوان</label>
                                        <input type="text" class="form-control" name="nameex" id="nameex"
                                            placeholder="العنوان" value="{{ $data->name }}" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="exportnum">رقم الصادر</label>
                                    ...
                                    <select id="select-person-to" name="person_to" class="form-control">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                @if ($data->person_to == $user->id) selected @endif>
                                                {{ $user->username }} (الرقم العسكرى : {{ $user->military_number }})
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="active">الحاله</label>
                                    <select id="active" name="active" class="form-control">
                                        <option value="0" @if ($data->active == 0) selected @endif>مفعل
                                        </option>
                                        <option value="1" @if ($data->active == 1) selected @endif>غير مفعل
                                        </option>
                                    ...
                                    <select id="from_departement" name="from_departement" class="form-control">
                                        ...
                                        @foreach ($departments as $item)
                                            <option value="{{ $item->id }}"
                                                @if ($data->department_id == $item->id) selected @endif>{{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                {{-- <div class="modal fade" id="addFile" tabindex="-1"
                                    aria-labelledby="extern-departmentLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="extern-departmentLabel">إضافة ملفات جديدة</h5>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div id="fileInputs">
                                                            <div class="file-input mb-3">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-danger btn-sm remove-file">حذف</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="button" class="btn btn-primary btn-sm mt-2"
                                                    id="addFile">إضافة ملف جديد</button>
                            ...
                            <form action="{{ route('Export.update', ['Export' => $data->id]) }}" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <button type="button" class="btn btn-primary mt-3" data-bs-toggle="modal"
                                            style="display: none" id="extern-department-dev"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="active" name="active">
                                            ...
                                            <option value="1" @if ($data->active == 1) selected @endif>غير
                                                مفعل</option>
                ...
                <div class="modal fade" id="extern-department" tabindex="-1" aria-labelledby="extern-departmentLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="saveExternalDepartment" action="{{ route('department.ajax') }}"
                                    method="POST">
                                    @csrf
