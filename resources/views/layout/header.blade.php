        ...
        <div class="second-section d-flex col-md-9 col-sm-6">
            <div class="dropdown">
                ...
                <div id="dropdownMenu" class="dropdown-menu">
                 <ul>
                    ...
                    <li>   <a href="{{ route('#') }}" style="color:black;"> صفحة المستخدم     <i class="fa-solid fa-user mx-2"></i></a></li>
            ...
            <div class="input-group mx-2">
                ...
                <div class="form-outline mt-4">
                    <input type="search" id="q" name="q" class="form-control" placeholder="بحث" @isset($q)
                        value="{{$q}}" @endisset />
                </div>
                <select name="search" id="search" class="mt-4" style="direction:rtl;">
                    <option value="users" @isset($search) @if($search=='users' ) selected @endif @endisset>المستخدمين
                    </option>
                    <option value="dept" @isset($search) @if($search=='dept' ) selected @endif @endisset>الادارات
                    </option>
                    <option value="emps" @isset($search) @if($search=='emps' ) selected @endif @endisset>الموظفين
                    </option>
